...
export const useToPairs = function <T extends Record<string, any>>(
  obj: T,
): [string, any][] {
...
export const useOrderBy = function <T>(
  ...
  const sorted = [...collection].sort((a, b) => {
    const valueA =
      typeof iteratee === 'function' ? iteratee(a) : a[iteratee as keyof T]
    const valueB =
      typeof iteratee === 'function' ? iteratee(b) : b[iteratee as keyof T]
